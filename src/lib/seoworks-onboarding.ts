 ...
 */
export function transformToSEOWerksFormat(onboardingData: OnboardingFormData): SEOWerksSubmissionData {
  return {
...
export function getPackageDetails(packageType: 'SILVER' | 'GOLD' | 'PLATINUM') {
  const packages = {
    ...
    PLATINUM: {
      name: 'Platinum',
      priority: 'Premium',
      features: ['Full SEO Suite', 'Weekly Reports', '24/7 Support', 'Social Media Management', 'Custom Development']
    }
  };
