                      ...
                      {order.deliverables && order.deliverables.length > 0 && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium">
                            {order.deliverables.length} Deliverable
                            {order.deliverables.length > 1 ? 's' : ''}
                          </span>
                        </div>
                      )}
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      {getTaskTypeLabel(selectedOrder.taskType)} • Order #
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                ...
                                {deliverable.metadata?.wordCount &&
                                  ` • ${deliverable.metadata.wordCount} words`}
                                {deliverable.metadata?.seoScore &&
                                  ` • SEO Score: ${deliverable.metadata.seoScore}`}
                              </p>
                            </div>
                          </div>
                          {deliverable.fileUrl && (
